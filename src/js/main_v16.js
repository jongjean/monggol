...
function initThreeJS() {
    ...
    canvas.addEventListener('click', (event) => {
        ...
        if (intersects.length > 0 && isDoubleClick) {
            ...
            popup.style.cssText = 'position:fixed;top:0;left:0;width:100vw;height:100vh;background:rgba(0,0,0,0.95);z-index:10000;display:flex;align-items:center;justify-content:center;';
...
const closeBtn=document.createElement('button'); closeBtn.id='artwork-close-btn'; closeBtn.innerHTML='✕'; closeBtn.style.cssText='display:none;position:fixed;top:30px;right:30px;background:rgba(255,255,255,0.9);border:2px solid rgba(60,60,60,0.3);border-radius:50%;width:50px;height:50px;font-size:28px;color:rgba(60,60,60,1);cursor:pointer;z-index:200002;font-weight:300;box-shadow:0 3px 10px rgba(0,0,0,0.3);'; closeBtn.onclick=function(){window.closeArtwork();}; document.body.appendChild(closeBtn); 
